...
= 1.4.1 =
- Change the page title to draw attention to the chat buttons (Pro).
- Blur background on widget open (Pro).
...
= 1.3.7 =
- JS functions to show/hide contact form: 
- To open contact form: show_scw_contact_form()
- To hide contact form: hide_scw_contact_form()

= 1.3.6 =
- On hover text bug fixed

= 1.3.5 =
- Add same channel multiple times
