...
<div class="rounded-2xl border border-slate-200 bg-white shadow-sm">
    <div class="border-b border-slate-200 px-5! py-4!">
        <h3 class="text-lg! font-semibold! text-slate-900!"><?php esc_html_e("Notifications", "sticky-chat-widget") ?></h3>
        <p class="mt-1! text-sm! text-slate-500"><?php esc_html_e("Configure pending message badge count, colors, and page title behavior.", "sticky-chat-widget") ?></p>
    </div>
    <div class="p-5!">
        ...
        <div class="pending-message-setting mt-4! <?php echo ($pendingMessageSettings['has_pending_message'] == "yes") ? "active" : "" ?>">
            <div class="gp-form-field">
