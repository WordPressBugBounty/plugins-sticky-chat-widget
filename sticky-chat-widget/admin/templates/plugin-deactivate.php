        ...
        <form action="<?php echo esc_url(admin_url("admin-ajax.php")) ?>" method="post" id="<?php echo esc_attr($pluginSlug) ?>-deactivate-form">
            ...
            <div class="gp-popup-form-body">
                ...
                <div class="gp-popup-form-control">
                    <label for="email-<?php echo esc_attr($pluginSlug) ?>"><?php echo esc_html_e("Email address", "sticky-chat-widget") ?></label>
                    <input id="email-<?php echo esc_attr($pluginSlug) ?>" type="email" name="deactivate_email" value="<?php echo esc_attr(get_option('admin_email')) ?>" placeholder="<?php echo esc_html_e("Email address", "sticky-chat-widget") ?>" >
                </div>
                <div class="gp-popup-form-control">
                    <label for="deactivate_comment-<?php echo esc_attr($pluginSlug) ?>"><?php echo esc_html_e("Your comment", "sticky-chat-widget") ?></label>
                    <textarea rows="5" id="deactivate_comment-<?php echo esc_attr($pluginSlug) ?>" name="deactivate_comment"></textarea>
                </div>
            </div>
            <div class="gp-popup-form-footer">
                <input type="submit" class="button button-secondary gp-deactivate-button <?php echo esc_attr($pluginSlug) ?>-popup-submit" value="<?php echo esc_html_e("Submit & Deactivate", "sticky-chat-widget") ?>">
                <span class="gp-popup-loader <?php echo esc_attr($pluginSlug) ?>-loader"><img src="<?php echo esc_url(GSB_PLUGIN_URL . 'dist/admin/images/spinner.gif'); ?>" alt=""></span>
                <div class="gp-popup-action-buttons">
                    <input type="button" class="button button-secondary gp-skip-button <?php echo esc_attr($pluginSlug) ?>-skip-feedback" value="<?php echo esc_html_e("Skip & Deactivate", "sticky-chat-widget") ?>">
