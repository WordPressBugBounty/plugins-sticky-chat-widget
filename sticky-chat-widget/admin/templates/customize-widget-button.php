    ...
    <div class="col-span-7 space-y-5!">
        <div class="rounded-2xl border border-slate-200 bg-white shadow-sm">
            <div class="border-b border-slate-200 px-5! py-4!">
                <h3 class="text-lg! font-semibold! text-slate-900!"><?php esc_html_e("Layout", "sticky-chat-widget") ?></h3>
                <p class="mt-1! text-sm! text-slate-500"><?php esc_html_e("Choose widget view style, main icon, and icon direction.", "sticky-chat-widget") ?></p>
            </div>
            <div class="p-5!">
                <div class="space-y-4!">
                    <div class="gp-form-field">
                        <div class="gp-form-label">
                            <label class="text-sm font-medium text-slate-700"><?php esc_html_e("Select View", "sticky-chat-widget") ?></label>
                        </div>
                        <div class="gp-form-input">
                            <div class="image-radio-buttons in-flex">
                                <div class="image-radio-button">
                                    ...
                                    <label for="view_icon" class="radio-image"><img src='<?php echo esc_url(GSB_PLUGIN_URL)."dist/admin/images/icon-view.svg"; ?>' alt="Icon view"></label>
                                    <label for="view_icon" class="radio-image-checked"><img src='<?php echo esc_url(GSB_PLUGIN_URL)."dist/admin/images/icon-view-selected.svg"; ?>' alt="Icon view selected"></label>
                                ...
                                <div class="image-radio-button">
                                    ...
                                    <label for="view_list" class="radio-image"><img src='<?php echo esc_url(GSB_PLUGIN_URL)."dist/admin/images/list-view.svg"; ?>' alt="List view"></label>
                                    <label for="view_list" class="radio-image-checked"><img src='<?php echo esc_url(GSB_PLUGIN_URL)."dist/admin/images/list-view-selected.svg"; ?>' alt="List view selected"></label>
                                ...
                                <div class="image-radio-button">
                                    ...
                                    <label for="view_grid" class="radio-image"><img src='<?php echo esc_url(GSB_PLUGIN_URL)."dist/admin/images/grid-view.svg"; ?>' alt="Grid view"></label>
                                    <label for="view_grid" class="radio-image-checked"><img src='<?php echo esc_url(GSB_PLUGIN_URL)."dist/admin/images/grid-view-selected.svg"; ?>' alt="Grid view selected"></label>
                                ...
                                <div class="image-radio-button">
                                    ...
                                    <label for="corner_circle_icon" class="radio-image"><img src='<?php echo esc_url(GSB_PLUGIN_URL)."dist/admin/images/corner-circle.svg"; ?>' alt="Corner circle"></label>
                                    <label for="corner_circle_icon" class="radio-image-checked"><img src='<?php echo esc_url(GSB_PLUGIN_URL)."dist/admin/images/corner-circle-selected.svg"; ?>' alt="Corner circle selected"></label>
                                ...
                                <div class="image-radio-button">
                                    ...
                                    <label for="menu_icon" class="radio-image"><img src='<?php echo esc_url(GSB_PLUGIN_URL)."dist/admin/images/menu-view.svg"; ?>' alt="Menu view"></label>
                                    <label for="menu_icon" class="radio-image-checked"><img src='<?php echo esc_url(GSB_PLUGIN_URL)."dist/admin/images/menu-view-selected.svg"; ?>' alt="Menu view selected"></label>
                    ...
                    <div class="gp-form-field menu-view icon-view-field <?php echo ($widgetSettings['view'] == "icon_view") ? "active activate" : "" ?>">
                        <div class="gp-form-label">
        ...
        <?php
        $title = "";
        if($widgetSettings['view'] == "list_view") {
            $title = "List view setting";
        } else if($widgetSettings['view'] == "grid_view") {
            $title = "Grid view setting";
        }
        ?>
        <div class="list-view-field rounded-2xl border border-slate-200 bg-white shadow-sm <?php echo ($widgetSettings['view'] != "icon_view" && $widgetSettings['view'] != 'corner_circle_view' && $widgetSettings['view'] != 'menu_view') ? "active" : "" ?>">
            <div class="border-b border-slate-200 px-5! py-4!">
                <h3 class="text-lg! font-semibold! text-slate-900! view-container-title"><?php echo $title; ?></h3>
                <p class="mt-1! text-sm! text-slate-500"><?php esc_html_e("Customize the header, message content, and colors for your expanded view.", "sticky-chat-widget") ?></p>
            </div>
            <div class="p-5!">
                <div class="space-y-4!">
                    <div class="gp-form-field">
                                ...
                                <span class="dashboard-switch in-flex on-off">
                                    ...
                                    <label for="woocommerce_customization">
                                        <span class="flex items-center gap-1">
                                            ...
                                            <span><?php esc_html_e("WooCommerce Customization", "sticky-chat-widget") ?></span>
                                        </span>
                                    </label>
                                </span>
                            </div>
        ...
        <div class="rounded-2xl border border-slate-200 bg-white shadow-sm">
            <div class="border-b border-slate-200 px-5! py-4!">
                <h3 class="text-lg! font-semibold! text-slate-900!"><?php esc_html_e("Position", "sticky-chat-widget") ?></h3>
                <p class="mt-1! text-sm! text-slate-500"><?php esc_html_e("Set where the widget appears on desktop and mobile screens.", "sticky-chat-widget") ?></p>
            </div>
            <div class="p-5!">
                <div class="space-y-4!">
                    <div class="gp-form-field">
                    ...
                    <div class="gp-form-field position-in-mobile-toggle">
                        <div class="gp-form-label">
                        </div>
                        <div class="gp-form-input d-flex">
                            <span class="dashboard-switch in-flex on-off">
        ...
        <div class="rounded-2xl border border-slate-200 bg-white shadow-sm">
            <div class="border-b border-slate-200 px-5! py-4!">
                <h3 class="text-lg! font-semibold! text-slate-900!"><?php esc_html_e("Content", "sticky-chat-widget") ?></h3>
                <p class="mt-1! text-sm! text-slate-500"><?php esc_html_e("Customize the text, greeting message, and CTA content shown in your widget.", "sticky-chat-widget") ?></p>
            </div>
            <div class="p-5!">
                <div class="space-y-4!">
                    <div class="gp-form-field">
        ...
        <div class="rounded-2xl border border-slate-200 bg-white shadow-sm">
            <div class="border-b border-slate-200 px-5! py-4!">
                <h3 class="text-lg! font-semibold! text-slate-900!"><?php esc_html_e("Style", "sticky-chat-widget") ?></h3>
                <p class="mt-1! text-sm! text-slate-500"><?php esc_html_e("Customize widget colors, icon appearance, shape, and typography.", "sticky-chat-widget") ?></p>
            </div>
            <div class="p-5!">
                <div class="space-y-4!">
                    <div class="flex-input">
        ...
        <div class="rounded-2xl border border-slate-200 bg-white shadow-sm">
            <div class="border-b border-slate-200 px-5! py-4!">
                <h3 class="text-lg! font-semibold! text-slate-900!"><?php esc_html_e("Behavior", "sticky-chat-widget") ?></h3>
                <p class="mt-1! text-sm! text-slate-500"><?php esc_html_e("Control widget animations, default state, and interaction behavior.", "sticky-chat-widget") ?></p>
            </div>
            <div class="p-5!">
                <div class="space-y-4!">
                    <div class="gp-form-field menu-animation icon-view-field <?php echo ($widgetSettings['view'] == "icon_view") ? "active activate" : "" ?>">
                        <div class="gp-form-label">
