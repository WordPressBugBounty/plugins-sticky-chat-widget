...
class GP_Admin_Common_Sticky_Chat_Widget
{
    ...
    public function admin_notices()
    {
        ...
        if (isset($_GET['page']) && ($_GET['page'] == "sticky-chat-widget" || $_GET['page'] == "sticky-chat-widget-upgrade-to-pro" || $_GET['page'] == "sticky-chat-widget-leads")) {
